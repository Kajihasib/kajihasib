...
const TMP_SCROLL_ACTIVATION = "scroll-trigger";
(TMP_SCROLL_OFFSCREEN_ACTIVATION = "scroll-trigger--offscreen"),
  (TMP_SCROLL_ZOOM_IN_ACTIVATION = "animate--zoom-in"),
  (TMP_SCROLL_CANCEL_ACTIVATION = "scroll-trigger--cancel");
...
function initializeScrollAnimationTrigger(
  ...
  if (isDesignModeEvent) {
    animationTriggerElements.each(function () {
      $(this).addClass("scroll-trigger--design-mode");
    });
    return;
  }
